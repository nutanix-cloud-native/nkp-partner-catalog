---
title: nkp update nodepool aws
sidebar_label: nkp update nodepool aws
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_minor: 2.14
nkp_patch: 2.14.3
nkp_command_id: nkp_update_nodepool_aws
...
<dd>Query string used in search of AMIs. Example: When --ami-base-os='rhel8.10', then the string 'prefix-&#123;&#123;.BaseOS&#125;&#125;-?&#123;&#123;.K8sVersion&#125;&#125;-&#42;' matches any AMIs with the Name 'prefix-rhel8.10-1.31.12</dd>
...
<dd>Instance type to use for node pool machines</dd>
