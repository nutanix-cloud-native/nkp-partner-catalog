---
title: nkp create cluster vcd
sidebar_label: nkp create cluster vcd
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_minor: 2.13
nkp_patch: 2.13.3
nkp_command_id: nkp_create_cluster_vcd
...
<dt><code>--control-plane-disk-size</code> <span class="cli-opt__type">int32</span></dt>
...
<dd>The control plane endpoint IP or hostname.</dd>
...
<dt><code>--control-plane-placement-policy</code> <span class="cli-opt__type">string</span></dt>
<dd>The placement policy for control plane to be used on this machine</dd>
...
<dt><code>--control-plane-sizing-policy</code> <span class="cli-opt__type">string</span></dt>
<dd>The sizing policy for control plane to be used on this machine</dd>
<dt><code>--data-center</code> <span class="cli-opt__type">string</span></dt>
<dd>The organization's virtual datacenter name where the cluster should be deployed.</dd>
...
<dt><code>--loadbalancer-network-cidr</code></dt>
<dd>cidr The load balancer CIDR to use for both the control plane nodes and kubernetes external services</dd>
...
<dd>The organization's virtual datacenter network to be used by the cluster.</dd>
...
<dt><code>--organization</code> <span class="cli-opt__type">string</span></dt>
<dd>The organization name where the cluster should be deployed.</dd>
...
<dt><code>--site</code> <span class="cli-opt__type">url</span></dt>
<dd>The cloud director's endpoint with the format https://VCD&#95;HOST.</dd>
