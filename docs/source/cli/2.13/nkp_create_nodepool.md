...
Create a nodepool, one of [aks, aws, azure, eks, gcp, nutanix, preprovisioned, vcd, vsphere]
...
* [nkp create nodepool eks](nkp_create_nodepool_eks.md) — Create a nodepool for EKS
...
* [nkp create nodepool preprovisioned](nkp_create_nodepool_preprovisioned.md) — Create a nodepool for a Pre Provisioned Cluster.
* [nkp create nodepool vcd](nkp_create_nodepool_vcd.md) — Create a nodepool in VCD
