---
title: nkp config set default-workspace
sidebar_label: nkp config set default-workspace
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_minor: 2.15
nkp_patch: 2.15.2
nkp_command_id: nkp_config_set_default-workspace
...
```bash
nkp config set default-workspace [WORKSPACE] [flags]
```

### Parent command

* [nkp config set](nkp_config_set.md) — Modify Kommander configuration
