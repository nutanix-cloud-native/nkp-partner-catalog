---
title: nkp update bootstrap credentials vsphere
sidebar_label: nkp update bootstrap credentials vsphere
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_minor: 2.12
nkp_patch: 2.12.2
nkp_command_id: nkp_update_bootstrap_credentials_vsphere
...
```bash
nkp update bootstrap credentials vsphere [flags]
```
