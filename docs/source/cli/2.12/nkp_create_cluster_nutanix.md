...
<dt><code>--cluster-class</code> <span class="cli-opt__type">string</span> <span class="cli-opt__default">default <code>nkp-nutanix</code></span></dt>
<dd>The name of the ClusterClass to create a cluster from</dd>
...
<dd>file Path to file containinng the CA certificate used to verify the registry server certificate</dd>
