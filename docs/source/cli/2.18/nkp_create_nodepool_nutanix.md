...
<dd>Name of the GPU resource. Can be either vGPU profile or name of passthrough GPU.</dd>
...
<dd>Name of the VM profile to use for worker machine. Cannot be used with machine configuration flags: --cores-per-vcpu, --vcpus, --memory, --gpu-name, --gpu-count.</dd>
