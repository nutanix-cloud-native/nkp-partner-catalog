...
<dt><code>--disable-appdeployments</code> <span class="cli-opt__type">strings</span> <span class="cli-opt__default">default <code>&#91;&#93;</code></span></dt>
<dd>List of AppDeployments to be disabled during upgrade</dd>
<dt><code>-h</code>, <code>--help</code></dt>
<dd>help for kommander</dd>
<dt><code>--kommander-applications-repository</code> <span class="cli-opt__type">string</span> <span class="cli-opt__default">default <code>v2.18.0</code></span></dt>
...
<dt><code>--platform-apps-timeout</code> <span class="cli-opt__type">duration</span> <span class="cli-opt__default">default <code>1h0m0s</code></span></dt>
