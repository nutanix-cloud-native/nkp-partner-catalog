---
title: nkp update controlplane nutanix
sidebar_label: nkp update controlplane nutanix
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_minor: 2.18
nkp_patch: 2.18.0
nkp_command_id: nkp_update_controlplane_nutanix
nkp_command_kind: leaf
---

<div class="cli-doc-ref" aria-hidden="true"></div>

Update a Kubernetes cluster control plane in Nutanix
...
```bash
nkp update controlplane nutanix [flags]
```
