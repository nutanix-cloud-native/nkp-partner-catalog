---
title: nkp get projects
sidebar_label: nkp get projects
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_minor: 2.18
nkp_patch: 2.18.0
nkp_command_id: nkp_get_projects
nkp_command_kind: leaf
---

<div class="cli-doc-ref" aria-hidden="true"></div>

Get Projects from a Workspace or all Workspaces
...
<dd>Name of the workspace to show Projects from</dd>
</dl>

### Usage

```bash
nkp get projects [PROJECT_NAME] [flags]
```
