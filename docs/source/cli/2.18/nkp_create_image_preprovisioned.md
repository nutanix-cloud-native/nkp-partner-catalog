---
title: nkp create image preprovisioned
sidebar_label: nkp create image preprovisioned
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_minor: 2.18
nkp_patch: 2.18.0
nkp_command_id: nkp_create_image_preprovisioned
nkp_command_kind: leaf
---

<div class="cli-doc-ref" aria-hidden="true"></div>

Configuring an existing remote host
...
```bash
nkp create image preprovisioned [flags]
```
