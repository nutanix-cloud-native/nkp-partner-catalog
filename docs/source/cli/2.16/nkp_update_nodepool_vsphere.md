---
title: nkp update nodepool vsphere
sidebar_label: nkp update nodepool vsphere
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_minor: 2.16
nkp_patch: 2.16.1
nkp_command_id: nkp_update_nodepool_vsphere
...
* [nkp update nodepool](nkp_update_nodepool.md) — Upate a Kubernetes cluster node pool, one of \[aws, azure, eks, gcp, preprovisioned, vsphere\]
