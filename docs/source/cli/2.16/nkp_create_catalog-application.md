---
title: nkp create catalog-application
sidebar_label: nkp create catalog-application
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_minor: 2.16
nkp_patch: 2.16.1
nkp_command_id: nkp_create_catalog-application
...
<dd>help for catalog-application</dd>
