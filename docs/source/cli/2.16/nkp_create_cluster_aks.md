...
<dd>Kubernetes version. Run 'az aks get-versions -o table --location &lt;location&gt;' to see available versions. See https://docs.microsoft.com/en-us/azure/aks/supported-kubernetes-versions for more details. Must be a patch version for v1.33.x.</dd>
