---
title: nkp create resource nutanix NutanixMetroSite
sidebar_label: nkp create resource nutanix NutanixMetroSite
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_command_id: nkp_create_resource_nutanix_NutanixMetroSite
nkp_command_kind: leaf
---

<div class="cli-doc-ref" aria-hidden="true"></div>

Create a Nutanix metro site resource
...
<dt><code>--group-name-label</code> <span class="cli-opt__type">string</span></dt>
<dd>Optional group label for nodes anchored to a topology segment</dd>
<dt><code>-h</code>, <code>--help</code></dt>
<dd>help for NutanixMetroSite</dd>
...
<dt><code>--metro</code> <span class="cli-opt__type">string</span></dt>
<dd>Name of the referenced NutanixMetro object</dd>
<dt><code>--name</code> <span class="cli-opt__type">string</span></dt>
<dd>Name of the metro site resource</dd>
...
<dt><code>--preferred-failure-domain</code> <span class="cli-opt__type">string</span></dt>
<dd>Name of the preferred NutanixFailureDomain object</dd>
...
```bash
nkp create resource nutanix NutanixMetroSite [flags]
```
