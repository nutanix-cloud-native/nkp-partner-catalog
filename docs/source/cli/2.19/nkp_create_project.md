---
title: nkp create project
sidebar_label: nkp create project
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_command_id: nkp_create_project
...
<dd>Display name shown in the UI (defaults to PROJECT&#95;NAME)</dd>
<dt><code>--dry-run</code></dt>
<dd>Export in YAML format to stdout</dd>
<dt><code>-h</code>, <code>--help</code></dt>
<dd>help for project</dd>
...
<dd>Optional namespace name to use for the project (immutable)</dd>
...
<dd>Name of the Workspace the project belongs to</dd>
<dt><code>--workspace-namespace</code> <span class="cli-opt__type">string</span></dt>
<dd>Namespace backing the Workspace (where the Project CR is created). If empty, it will be looked up from the Workspace.</dd>
</dl>

### Usage

```bash
nkp create project PROJECT_NAME [flags]
```
