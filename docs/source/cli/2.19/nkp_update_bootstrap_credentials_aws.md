---
title: nkp update bootstrap credentials aws
sidebar_label: nkp update bootstrap credentials aws
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_command_id: nkp_update_bootstrap_credentials_aws
...
```bash
nkp update bootstrap credentials aws [flags]
```
