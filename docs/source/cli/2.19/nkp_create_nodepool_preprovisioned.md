---
title: nkp create nodepool preprovisioned
sidebar_label: nkp create nodepool preprovisioned
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_command_id: nkp_create_nodepool_preprovisioned
nkp_command_kind: leaf
---

<div class="cli-doc-ref" aria-hidden="true"></div>

Create a nodepool in Preprovisioned.
...
```bash
nkp create nodepool preprovisioned NAME [flags]
```
