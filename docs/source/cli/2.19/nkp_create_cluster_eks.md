---
title: nkp create cluster eks
sidebar_label: nkp create cluster eks
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_command_id: nkp_create_cluster_eks
...
<dt><code>--kubernetes-version</code> <span class="cli-opt__type">string</span> <span class="cli-opt__default">default <code>1.36.0</code></span></dt>
...
<dt><code>--worker-placement-group</code> <span class="cli-opt__type">string</span></dt>
<dd>AWS Placement group to deploy the worker machines to. The placement group must already exist.</dd>
