...
<dt><code>--bootstrap-cluster-image</code> <span class="cli-opt__type">string</span> <span class="cli-opt__default">default <code>docker.io/mesosphere/konvoy-bootstrap:v2.19.0-dev</code></span></dt>
<dd>Container image used to create the bootstrap cluster. Can be an image name or path to a file, e.g., ./nkp-v2.19.0-dev/konvoy-bootstrap-image-v2.19.0-dev.tar. If not provided, the default image will be used</dd>
<dt><code>--bundle</code> <span class="cli-opt__type">files</span> <span class="cli-opt__default">default <code>&#91;&#93;</code></span></dt>
<dd>A comma separated list of bundle artifacts that will be pushed to an in-cluster registry. Supports glob pattern to match multiple artifacts (e.g. ./bundles/&#42;.tar). Following artifacts must be provided: konvoy-image-bundle-v2.19.0-dev.tar, kommander-image-bundle-v2.19.0-dev.tar</dd>
...
<dt><code>--control-plane-failure-domains</code> <span class="cli-opt__type">strings</span></dt>
<dd>The failure-domains used to provision control-plane machines. These failure-domain types are supported:</dd>
...
<dt><code>--ha-topology-config</code> <span class="cli-opt__type">string</span></dt>
<dd>The ha-topology yaml config file path. (required: false)</dd>
...
<dt><code>--onboard-to-prism-central</code> <span class="cli-opt__default">default <code>true</code></span></dt>
<dd>Makes the cluster visible in the Prism Central in the infrastructure tab.</dd>
...
<dd>Name of the Prism Central project to associate with all cluster resources (VMs, VGs, etc).</dd>
...
<dt><code>--worker-vm-profile</code> <span class="cli-opt__type">string</span></dt>
<dd>Name of the VM profile to use for worker machine. Cannot be used with machine configuration flags: --worker-cores-per-vcpu, --worker-vcpus, --worker-memory.</dd>
</dl>
...
* [nkp create cluster](nkp_create_cluster.md) — Cluster one of \[aks, aws, azure, docker, eks, gcp, metal, nutanix, preprovisioned, vsphere\]
