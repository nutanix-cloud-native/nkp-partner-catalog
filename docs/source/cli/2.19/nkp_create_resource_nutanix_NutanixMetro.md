---
title: nkp create resource nutanix NutanixMetro
sidebar_label: nkp create resource nutanix NutanixMetro
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_command_id: nkp_create_resource_nutanix_NutanixMetro
nkp_command_kind: leaf
---

<div class="cli-doc-ref" aria-hidden="true"></div>

Create a Nutanix metro resource
...
<dt><code>--failure-domains</code> <span class="cli-opt__type">strings</span> <span class="cli-opt__default">default <code>&#91;&#93;</code></span></dt>
<dd>Names of two NutanixFailureDomain objects (example: fd1,fd2)</dd>
<dt><code>-h</code>, <code>--help</code></dt>
<dd>help for NutanixMetro</dd>
...
<dd>Name of the metro resource</dd>
...
```bash
nkp create resource nutanix NutanixMetro [flags]
```
