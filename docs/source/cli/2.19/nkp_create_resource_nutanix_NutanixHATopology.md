---
title: nkp create resource nutanix NutanixHATopology
sidebar_label: nkp create resource nutanix NutanixHATopology
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_command_id: nkp_create_resource_nutanix_NutanixHATopology
nkp_command_kind: leaf
---

<div class="cli-doc-ref" aria-hidden="true"></div>

Create Nutanix failure-domain/metro/metro-site resources from HA topology config

### Options

<dl class="cli-opts">
<dt><code>--config</code> <span class="cli-opt__type">string</span></dt>
<dd>Path to the HA topology yaml config file</dd>
<dt><code>--dry-run</code></dt>
<dd>Only print the objects that would be created, without creating them.</dd>
<dt><code>-h</code>, <code>--help</code></dt>
<dd>help for NutanixHATopology</dd>
...
```bash
nkp create resource nutanix NutanixHATopology [flags]
```
