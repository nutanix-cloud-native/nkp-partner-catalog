---
title: nkp update controlplane gcp
sidebar_label: nkp update controlplane gcp
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_command_id: nkp_update_controlplane_gcp
...
<dd>Control Plane machine instance type (ex. "n2-standard-4")</dd>
