...
<dt><code>--override-file</code> <span class="cli-opt__type">string</span></dt>
<dd>Path to a file containing any provided overrides on a preprovisioned cluster. All overrides defined at provisioning should be present in this file.</dd>
...
<dt><code>--timeout</code> <span class="cli-opt__type">duration</span> <span class="cli-opt__default">default <code>45m0s</code></span></dt>
