---
title: nkp delete bootstrap
sidebar_label: nkp delete bootstrap
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_minor: 2.17
nkp_patch: 2.17.1
nkp_command_id: nkp_delete_bootstrap
...
<dt><code>--kind-cluster-name</code> <span class="cli-opt__type">string</span> <span class="cli-opt__default">default <code>konvoy-capi-bootstrapper</code></span></dt>
<dd>Kind cluster name for the bootstrap cluster</dd>
