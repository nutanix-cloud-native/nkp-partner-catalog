---
title: nkp legacy update controlplane eks
sidebar_label: nkp legacy update controlplane eks
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_minor: 2.17
nkp_patch: 2.17.1
nkp_command_id: nkp_legacy_update_controlplane_eks
nkp_command_kind: leaf
---

<div class="cli-doc-ref" aria-hidden="true"></div>

Update a Kubernetes cluster control plane in EKS
...
```bash
nkp legacy update controlplane eks [flags]
```

### Parent command

* [nkp legacy update controlplane](nkp_legacy_update_controlplane.md) — Update a Kubernetes cluster control plane, one of \[eks\]
