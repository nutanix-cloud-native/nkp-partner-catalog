...
<dt><code>--disable-appdeployments</code> <span class="cli-opt__type">strings</span> <span class="cli-opt__default">default <code>&#91;centralized-kubecost,kubecost-thanos-traefik&#93;</code></span></dt>
<dd>List of AppDeployments to be disabled during upgrade</dd>
<dt><code>-h</code>, <code>--help</code></dt>
<dd>help for kommander</dd>
<dt><code>--kommander-applications-repository</code> <span class="cli-opt__type">string</span> <span class="cli-opt__default">default <code>v2.17.1</code></span></dt>
...
<dt><code>--kubecost-preserve-all-resources</code></dt>
<dd>whether to orphan Kubecost so that it's no longer managed by NKP while keep its underlying resources running in order to upgrade to 2.17</dd>
