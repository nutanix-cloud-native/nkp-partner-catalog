---
title: nkp legacy upgrade addons eks
sidebar_label: nkp legacy upgrade addons eks
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_minor: 2.17
nkp_patch: 2.17.1
nkp_command_id: nkp_legacy_upgrade_addons_eks
...
* [nkp legacy upgrade addons](nkp_legacy_upgrade_addons.md) — Upgrade the core Addons in a cluster, one of \[eks\]
