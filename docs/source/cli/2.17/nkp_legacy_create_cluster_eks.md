---
title: nkp legacy create cluster eks
sidebar_label: nkp legacy create cluster eks
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_minor: 2.17
nkp_patch: 2.17.1
nkp_command_id: nkp_legacy_create_cluster_eks
...
* [nkp legacy create cluster](nkp_legacy_create_cluster.md) — Create a cluster
