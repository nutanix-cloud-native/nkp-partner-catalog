---
title: nkp update controlplane aks
sidebar_label: nkp update controlplane aks
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_minor: 2.17
nkp_patch: 2.17.1
nkp_command_id: nkp_update_controlplane_aks
nkp_command_kind: leaf
---

<div class="cli-doc-ref" aria-hidden="true"></div>

Update a Kubernetes cluster control plane in AKS
...
```bash
nkp update controlplane aks [flags]
```
