---
title: nkp legacy update nodepool eks
sidebar_label: nkp legacy update nodepool eks
sidebar_position: 10
cli_generated: true
unlisted: true
...
nkp_minor: 2.17
nkp_patch: 2.17.1
nkp_command_id: nkp_legacy_update_nodepool_eks
...
* [nkp legacy update nodepool](nkp_legacy_update_nodepool.md) — Upate a Kubernetes cluster node pool, one of \[eks\]
