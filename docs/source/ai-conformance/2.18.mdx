...
<div style={{ float: 'right', width: '140px', margin: '0 0 0.75rem 1rem', textAlign: 'center' }}>
  <a href="https://github.com/cncf/k8s-ai-conformance/tree/main/v1.35/nkp" target="_blank" rel="noopener noreferrer">
    <img
...
This page shows how NKP 2.18 meets these requirements using Kubernetes v1.35.2 and the NVIDIA GPU Operator v26.3.0, deployed via Flux CD as platform HelmReleases. NKP 2.19 verification against the v1.36 checklist is on the [NKP 2.19 page](/docs/ai-conformance/2.19).

<div style={{ clear: 'both' }} />

:::note
NKP is **CNCF Kubernetes AI Conformant** for v1.35; see the [v1.35 NKP AI conformance submission](https://github.com/cncf/k8s-ai-conformance/tree/main/v1.35/nkp). NKP also holds **CNCF Certified Kubernetes** conformance, which AI Conformance builds on. That certification was submitted under NKP's former product name, **Konvoy**; see the [v1.35 Konvoy conformance submission](https://github.com/cncf/k8s-conformance/tree/master/v1.35/konvoy). For installation, configuration, and operations guidance, see the official [NKP 2.18 documentation](https://portal.nutanix.com/page/documents/details?targetId=Nutanix-Kubernetes-Platform-v2_18).
:::
...
[Kueue](https://nutanix-cloud-native.github.io/nkp-partner-catalog/docs/applications/kueue) is a Kubernetes-native job queueing and quota system for batch and AI/ML workloads. Its controller is natively instrumented and serves Prometheus metrics on a secured `/metrics` endpoint (port `8443`).
...
- [Slurm Operator](https://nutanix-cloud-native.github.io/nkp-partner-catalog/docs/applications/slurm-operator) — Kubernetes operator (Slinky project) for running and managing Slurm clusters, with CRDs (Controller, NodeSet, LoginSet, RestApi, Accounting, Token) and mutating/validating admission webhooks.
- [kagent](https://nutanix-cloud-native.github.io/nkp-partner-catalog/docs/applications/kagent) — Declarative AI agent lifecycle management with CRDs (Agent, Tool, ModelConfig, Team) and admission webhooks.
- [Milvus Operator](https://nutanix-cloud-native.github.io/nkp-partner-catalog/docs/applications/milvus-operator) — Manages vector database instances.
